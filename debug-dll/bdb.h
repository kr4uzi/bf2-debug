...
bf2py::bdb::exception_mode operator|(bf2py::bdb::exception_mode lhs, bf2py::bdb::exception_mode rhs);
bool operator&(bf2py::bdb::exception_mode lhs, bf2py::bdb::exception_mode rhs);